...
| Blocks-Toolbox | 🔄 In Progress | 71% | Directory structure, basic files, layout subsection, basic subsection, device-input subsection, ai subsection, and actions subsection completed |
...
2. Migrate the Blocks-Toolbox section pages 🔄
   ...
   - Other subsections (advanced, recommendations, visualizations) 🔄 (In Progress)
3. Update links and references in these pages 🔄
4. Migrate images used in these pages 🔄
